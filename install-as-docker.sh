...
ARGS="-etcd $ETCD_ENDPOINTS -if $INTERFACE -lease-start $LEASE_START -lease-range $LEASE_RANGE -dns $DNS -http-listen 0.0.0.0:8000 -api-listen 0.0.0.0:8001 $OTHER_ARGS"
