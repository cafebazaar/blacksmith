...
func templateFuncs(rootTemplate *template.Template, ds datasource.DataSource, machineInterface datasource.EtcdMachineInterface) map[string]interface{} {
	return map[string]interface{}{
...
func executeGeneralTemplate(rootTemplate *template.Template, templateName string, ds datasource.DataSource, machineInterface datasource.EtcdMachineInterface) (string, error) {
...
func ExecuteTemplateFile(tmpl string,
	ds datasource.DataSource, machineInterface datasource.EtcdMachineInterface) (string, error) {
