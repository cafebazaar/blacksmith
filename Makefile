...
/tmp/blacksmith/workspaces/dummy-workspace/initial.yaml:
	...
	echo "---" > $(DUMMY_WORKSPACE)/initial.yaml
	echo "# This file is generated by the $@ makefile target of $(abspath .)" >> $(DUMMY_WORKSPACE)/initial.yaml
	echo "cluster-variables:" >> $(DUMMY_WORKSPACE)/initial.yaml
	echo "  coreos-version: \"1235.12.0\"" >> $(DUMMY_WORKSPACE)/initial.yaml
