...
func templateFuncs(rootTemplate *template.Template, ds *datasource.EtcdDatasource, machineInterface *datasource.EtcdMachine) map[string]interface{} {
	return map[string]interface{}{
...
func executeGeneralTemplate(rootTemplate *template.Template, templateName string, ds *datasource.EtcdDatasource, machineInterface *datasource.EtcdMachine) (string, error) {
